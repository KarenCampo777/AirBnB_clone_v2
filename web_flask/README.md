...
* [Routing](https://flask.palletsprojects.com/en/1.0.x/quickstart/#routingRouting)
...
* [Lisst of Control Structures](https://jinja.palletsprojects.com/en/2.9.x/templates/#list-of-control-structures)
...
* How to display in HTML data from a MySQL databases
